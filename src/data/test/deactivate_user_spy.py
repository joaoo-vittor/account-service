...
class DeactivateUserSpy:
    ...
    def deactivate_user(
        ...
        self.deactivate_user_params["user_id"] = user_id
        self.deactivate_user_params["user_name"] = user_name
        self.deactivate_user_params["password"] = password
